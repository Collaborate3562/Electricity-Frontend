...
class ForgotPassword extends Component {
    ...
    ForgotPassword( e) {
        ...
        if (this.validateForm()) {
            var apiBaseUrl = "http://localhost:8081/springfox/api/forgotPassword/" + this.state.newPassword;
                            ...
                            <div className="card-body">
                                <fieldset>
                                    <form>
                                        ...
                                        <button className="btn btn-primary" onClick={this.ForgotPassword}>Save</button>
